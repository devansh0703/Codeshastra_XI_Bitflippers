(async () => {
  ...
  const voting = Voting.attach("0x6eea0B8A2369AebdC10978CfC6041fb5EB68F375");
  ...
  const tx = await voting.castApprovalVote(a, b, c, input, candidateId, "0x9cF74138117A8425344B5BBC165A52c551a4d4bf");
  console.log("Voting tx hash:", tx.hash);
  await tx.wait();
  console.log("Vote cast and certificate minted!");
})();
